...
>
> **Note:** PRD names the product **SITE1**; the app currently brands as
> "SCS BuildHub". Rebrand pending decision (see status appendix).
...
| 6–7 | **Project Dashboard** | ⬜ | **The keystone (C2). Next build.** Projects still dead-end on click. |
